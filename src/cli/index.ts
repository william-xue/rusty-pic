 ...
 * 压缩命令实现
 */
async function compressCommand(input: string, options: any) {
 ...
 * 批量压缩命令实现
 */
async function batchCommand(input: string, options: any) {
 ...
 * 智能压缩命令实现
 */
async function smartCommand(input: string, options: any) {
 ...
 * 信息命令实现
 */
async function infoCommand(input: string) {
